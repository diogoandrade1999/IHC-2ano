...
public class LeaguesDetailsResultsAdapter extends RecyclerView.Adapter<LeaguesDetailsResultsAdapter.ViewHolder> {

    private List<ItemsLeaguesDetailsResults> listData;
    private Context context;
    private String country;
    private String flag;

    public LeaguesDetailsResultsAdapter(List<ItemsLeaguesDetailsResults> listData, Context context, String country, String flag){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.items_leagues_details_results, viewGroup, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        final ItemsLeaguesDetailsResults listItem = listData.get(i);
        ...
        if (!listItem.getScore().equals("null"))
            viewHolder.scoreView.setText(listItem.getScore());
